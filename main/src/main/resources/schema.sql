DROP TABLE IF EXISTS categories, users, locations, events, requests, compilations, events_compilations, user_event_reactions;
...
CREATE TABLE IF NOT EXISTS user_event_reactions
(
